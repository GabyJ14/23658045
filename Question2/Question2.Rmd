...
Explain what I will be doing in this section. 

#Data Preparation
load and inspect the data. Filter studio recording and live performances. 
...
#Coldplay Analysis
Look at how tempo changes when sung live compared to when in studio. 
Maybe add a picture of coldplay concert.
Look at popularity of albums. Maybe average tempo of album?

#Metallica Analysis
Look at how tempo changes when sung live compared to when in studio or demo. 
Maybe add a picture of a metallica poster.

#Broader Context Analysis
Integrating the spotify file and doing more analysis. 
Maybe compare metallica and coldplay with other artists in their genre?
